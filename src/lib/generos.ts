...
export const GENERO_FRASES: Record<Genero, string> = {
  ...
  "Policial / Thriller": "Sospecho de todos los personajes",
  Romance: "Lloro con los finales felices",
  Aventura: "Necesito acción en cada página",
  ...
  Viajes: "Leo para viajar sin salir de casa",
